    ...
    <section className="py-6 md:py-10 animate-fade-in">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        {features.map((feature) => (
          ...
          >
            <div className="w-14 h-14 rounded-full bg-[#f7c2d4]/30 flex justify-center items-center scale-90">
              {feature.icon}
            </div>
            <div>
              ...
              <p className="text-[0.9rem] text-[rgba(131,37,78,0.7)] leading-relaxed">
                {feature.description}
              </p>
            </div>
          </div>
